"""Evaluation and gates for the root-rotation sagittal pelvis-angle v3.
...
authority.  v3 consumes physical-space, already-consistent G0/G1 motion and
...
v3_PROTOCOL = "vimogen_absolute_mean_pelvis_v3_tail_safe"
...
def evaluate_single(
    *,
    ...
    """Evaluate one physical-space G0/G1 pair under the v3 protocol."""
    ...
    row: dict[str, Any] = {
        ...
        "angle_authority": "root_rotation_local_sagittal_tilt_v3",
        "sample_id": sample_id,
        "method": method,
        "seed": int(seed),
...
def summarize_rows(rows: Iterable[Mapping[str, Any]]) -> dict[str, Any]:
    """Aggregate v1-compatible control metrics and v3 consistency maxima."""
...
def control_success_gate(
    ...
    *,
    ...
    """Apply the v1 control gate plus the complete v3 consistency gate."""
...
def g1_promotion_gate(
    *,
    ...
    """Retain the v1 G1 promotion rules for v3 summaries."""
