...
- IMPLEMENTED：从提交 `805a6a5` 建立独立工作树与分支 `codex/pelvis-contact-compensation-v3`，远端最新提交为 `3964f24`。新增 `evaluation/pelvis_contact_compensation_v3.py`、`sampling/pelvis_contact_compensation_v3.py`、协议冻结/运行/评价/渲染脚本及专项测试；ViMoGen 与 v1.3/v2.1 代码未覆盖。
